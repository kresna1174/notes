...
const COMMANDS = [
  // Basic Blocks
  {
    ...
    title: 'Teks',
    description: 'Mulai menulis dengan paragraf teks biasa.',
    icon: Type,
  ...
  },
  {
    category: 'Basic Blocks',
    title: 'Heading 1',
    description: 'Section heading berukuran besar.',
    icon: Heading1,
  ...
  },
  {
    category: 'Basic Blocks',
    title: 'Heading 2',
    description: 'Section heading berukuran sedang.',
    icon: Heading2,
  ...
  },
  {
    category: 'Basic Blocks',
    title: 'Heading 3',
    description: 'Section heading berukuran kecil.',
    icon: Heading3,
  ...
  },
  {
    ...
    description: 'Buat daftar berpoin sederhana.',
    icon: List,
  ...
  },
  {
    ...
    description: 'Buat daftar dengan nomor berurutan.',
    icon: ListOrdered,
  ...
  },
  {
    ...
    description: 'Buat checklist tugas interaktif.',
    icon: CheckSquare,
  ...
  },
  {
    category: 'Basic Blocks',
    title: 'Toggle List',
    description: 'Blok collapsible untuk menyembunyikan detail.',
    icon: ChevronRight,
  ...
  },
  {
    category: 'Basic Blocks',
    title: 'Kutipan (Quote)',
    description: 'Tulis kutipan teks penting.',
    icon: Quote,
  ...
  },
  {
    category: 'Basic Blocks',
    title: 'Callout',
    description: 'Blok highlight berlatar warna dan ikon.',
    icon: Info,
  ...
  },
  {
    ...
    description: 'Garis horizontal pemisah konten.',
    icon: Minus,
  ...
  // Media & Advanced
  {
    ...
    title: 'Tabel',
    description: 'Sisipkan tabel data sederhana.',
    icon: Table,
  ...
  },
  {
    category: 'Media & Advanced',
    title: 'Web Bookmark',
    description: 'Sisipkan pratinjau tautan halaman web.',
    icon: Link2,
  ...
  },
  {
    ...
    description: 'Daftar indeks judul otomatis.',
    icon: FileText,
  ...
  },
  {
    category: 'Media & Advanced',
    title: 'Blok Kode',
    description: 'Tulis blok kode dengan sintaks terformat.',
    icon: Code,
  ...
  },
  {
    category: 'Media & Advanced',
    title: 'Lampiran (File)',
    description: 'Unggah dan sematkan file atau foto.',
    icon: Paperclip,
