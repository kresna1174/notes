  ...
  useEffect(() => {
    ...
    fetch(`/api/attachments/${attachmentId}/inline`)
      ...
      .catch(err => {
        ...
        setContent('Gagal memuat pratinjau file.')
      })
      .finally(() => {
        setLoading(false)
      })
        ...
        <div className="flex-1 overflow-auto p-6 bg-background/50">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-12 gap-3">
              ...
              <span className="text-sm text-muted-foreground">Memuat file…</span>
            </div>
          ) : isImg ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <span className="text-sm text-muted-foreground">Format file ini tidak mendukung pratinjau langsung.</span>
              <a
                href={`/api/attachments/${attachmentId}`}
                download={filename}
