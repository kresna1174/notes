            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.8rem', color: 'var(--fg-muted)', lineHeight: 1.5 }}>
                  Current note will be replaced with version{' '}
                  <strong style={{ color: 'var(--fg)' }}>
                    &ldquo;{confirmRestore.versionName || 'Auto Save'}&rdquo;
                  </strong>.
          ...
          {activeTab === 'diff' ? (
            ...
            <div style={{ flex: 1, overflowY: 'auto', fontFamily: 'monospace', fontSize: '0.8rem', lineHeight: 1.6 }}>
              ...
              <div style={{
                ...
                <span>@@ old version → current version @@</span>
              </div>

              {/* Diff lines */}
              {diffResult.length === 0 ? (
                <div style={{ padding: '40px', textAlign: 'center', color: 'var(--fg-muted)', fontSize: '0.85rem' }}>
                  No changes detected between this version and the current note.
                </div>
              ) : (
